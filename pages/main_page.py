...
class MainPage(BasePage):
    ...
    def add_ingredient_to_the_basket(self):
        ...
        self.add_to_the_basket(MainPageLocators.INGREDIENT_BUN_BUTTON, MainPageLocators.BASKET)
    ...
    def id_window_is_displayed(self): 
        ...
        self.wait_until_element_to_be_clickable(MainPageLocators.CLOSE_ORDER_NUMBER_BUTTUN)
    ...
    def сlick_closed_cross_button_Window_number_order(self):
        self.wait_element(MainPageLocators.CLOSE_ORDER_NUMBER_BUTTUN) 
        self.click_on_element(MainPageLocators.CLOSE_ORDER_NUMBER_BUTTUN)       
